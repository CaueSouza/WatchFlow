...
public class FabsFragment extends Fragment {
    ...
    private void initBindings() {
        ...
        binding.reloadFab.setOnClickListener(v -> viewModel.getRefreshEvent().call());

        binding.addUserFab.setOnClickListener(v -> viewModel.getAddUserEvent().call());

        binding.removeUserFab.setOnClickListener(v -> viewModel.getRemoveUserEvent().call());

        binding.addCamFab.setOnClickListener(v -> viewModel.getAddCamEvent().call());

        binding.logoutFab.setOnClickListener(v -> viewModel.getLogoutEvent().call());
    }
